        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-muted-foreground">
              A versatile Full Stack Web Developer with 8+ years of experience delivering robust, scalable, and secure web solutions across finance, healthcare, e-commerce, and IT sectors.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground text-center">
                Experienced Full Stack Web Developer specializing in building secure, scalable, and user-friendly web applications using modern technologies like React, Laravel, and Node.js.
              </p>
            </motion.div>
