  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      details: "auro19955252@gmail.com",
    ...
    },
    {
      ...
      link: "https://maps.google.com/?q=Zagreb",
    },
  ];
  ...
  const socialLinks = [
    {
      ...
      name: "GitHub",
      url: "https://github.com/Auro1995525/",
    },
    {
      icon: <Linkedin className="h-5 w-5" />,
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/Auro1995525/",
    },
    {
      icon: <Twitter className="h-5 w-5" />,
      name: "Twitter",
      url: "https://x.com/Auro1995525/",
    },
  ];
